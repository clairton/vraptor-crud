...
public class BaseSerializer extends AbstractBaseSerializer<Base> implements JsonSerializer<Base>, JsonDeserializer<Base> {
	private static final long serialVersionUID = 1L;

	@Inject
	public BaseSerializer(@NotNull final Inflector inflector, @NotNull EntityManager em) {
		super(inflector, em);
	}
